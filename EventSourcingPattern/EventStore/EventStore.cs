    ...
    public class EventStore : IDisposable
    {
        ...
        public EventStore()
        {
            _store = Wireup.Init()
              ...
              .UsingSqlPersistence("RemoteSQLStorageConnectionString")
        ...
        /// <param name="streamId"></param>
        /// <returns></returns>
        public double GetBalance(Guid customerId)
        {
            double result = 0;

            using (var stream = _store.OpenStream(customerId, 0, int.MaxValue))
            {
